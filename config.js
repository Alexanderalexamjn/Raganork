...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'sᴏᴜʀᴀᴠᴋʟ¹¹;𝒎𝒖𝒏𝒂𝒗𝒊𝒓;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? '𝒎𝒖𝒏𝒂𝒗𝒊𝒓¹¹' : process.env.OWNER_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/.munavir._' : process.env.IG,
    ...
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHa' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
